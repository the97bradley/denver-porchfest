...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "The lineup will be announced on September 5th. Check back on this site for updates.",
  },
  {
        ...
        <section className="mx-auto grid w-full max-w-6xl gap-10 px-6 py-16 md:grid-cols-2 md:py-20">
          <div className="space-y-6">
            ...
            <p className="max-w-xl text-lg text-[#4b5563]">
              ...
              Tickets are $20 per person, and proceeds support artist pay, neighborhood operations, and event-day logistics.
              We will also be
